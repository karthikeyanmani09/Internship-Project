            ...
            <div class="card-body" v-if="posts">
              ...
              <Form @submit="" >
                ...
                <div class="form-group">
                  ...
                  <Field type="text" :rules="validateForm" name="title" data-test="title" placeholder="Title" id="title"  v-model="posts.title" class="form-control title"/>
                ...
                <div class="form-group">
                  ...
                  <Field type="text" :rules="validateForm" name="body"  data-test="body" placeholder="Body" id="inputBody"  v-model="posts.body" class="form-control body" rows="3"/>
